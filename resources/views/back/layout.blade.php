  ...
  <aside class="main-sidebar">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="{{ route('employees.index') }}"><i class="fa fa-users"></i> <span>@lang('Employees')</span></a></li>

        <li><a href="{{ route('task.index') }}"><i class="fa fa-users"></i> <span>@lang('Tasks')</span></a></li>

        <li><a href="{{ route('employee_task.index') }}"><i class="fa fa-users"></i> <span>@lang('Employee Tasks')</span></a></li>

        <li><a href="{{ route('report.index') }}"><i class="fa fa-users"></i> <span>@lang('Reports')</span></a></li>
